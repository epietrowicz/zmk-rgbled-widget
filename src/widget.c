...
static const uint8_t layer_color_idx[] = {
    ...
    CONFIG_RGBLED_WIDGET_LAYER_4_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_5_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_6_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_7_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_8_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_9_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_10_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_11_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_12_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_13_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_14_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_15_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_16_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_17_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_18_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_19_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_20_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_21_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_22_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_23_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_24_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_25_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_26_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_27_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_28_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_29_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_30_COLOR,
    CONFIG_RGBLED_WIDGET_LAYER_31_COLOR,
};
#endif
...
#endif
    LOG_DBG("Indicating connectivity status with color %s",
...
void indicate_battery(void)
{
    ...
    LOG_INF("Indicating battery level %d", battery_level);
...
static int led_layer_color_listener_cb(const zmk_event_t *eh)
{
    ...
    LOG_INF("Led layer color listener callback triggered");
    ...
    if (initialized)
    {
        LOG_INF("Detected layer change event, updating layer color");
        update_layer_color();
    }
    return 0;
}
...
extern void led_process_thread(void *d0, void *d1, void *d2)
{
    ...
    while (true)
    {
        ...
        {
            LOG_DBG("Got a blink item from msgq, color %s, duration %d", color_names[blink.color],
                    blink.duration_ms);
            LOG_DBG("Current color is %s, layer color is %s",
                    color_names[led_current_color], color_names[led_layer_color]);
        ...
        {
            LOG_DBG("Got a color from msq, no duration %s", color_names[blink.color]);
